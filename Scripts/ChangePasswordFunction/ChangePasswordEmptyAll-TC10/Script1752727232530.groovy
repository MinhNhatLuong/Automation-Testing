...
WebUI.setText(findTestObject('Page_ng K - DUPSS/input__username'), 'testcp10')
...
WebUI.setText(findTestObject('Page_DUPSS - Phng Nga S Dng Ma Ty Trong Cng ng/input_newPassword'), '')

WebUI.setText(findTestObject('Page_DUPSS - Phng Nga S Dng Ma Ty Trong Cng ng/input_confirmNewPassword'), '')

WebUI.click(findTestObject('Page_DUPSS - Phng Nga S Dng Ma Ty Trong Cng ng/button_changePassword'))

WebUI.verifyTextPresent('Vui lòng nhập mật khẩu mới', false)

WebUI.verifyTextPresent('Vui lòng xác nhận mật khẩu mới', false)

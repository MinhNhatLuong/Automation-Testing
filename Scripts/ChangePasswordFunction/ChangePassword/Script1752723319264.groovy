...
WebUI.setText(findTestObject('Page_ng Nhp - DUPSS/input_password'), password)
...
WebUI.setText(findTestObject('Page_DUPSS - Phng Nga S Dng Ma Ty Trong Cng ng/input_currentPassword'), oldPassword)

WebUI.setText(findTestObject('Page_DUPSS - Phng Nga S Dng Ma Ty Trong Cng ng/input_newPassword'), newPassword)

WebUI.setText(findTestObject('Page_DUPSS - Phng Nga S Dng Ma Ty Trong Cng ng/input_confirmNewPassword'), confirmNewPassword)

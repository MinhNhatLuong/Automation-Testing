...
WebUI.setText(findTestObject('Page_ng K - DUPSS/input__username'), 'testcp04')
...
WebUI.setText(findTestObject('Page_DUPSS - Phng Nga S Dng Ma Ty Trong Cng ng/input_currentPassword'), 'WrongPass123')

WebUI.setText(findTestObject('Page_DUPSS - Phng Nga S Dng Ma Ty Trong Cng ng/input_newPassword'), 'NewPass@456')

WebUI.setText(findTestObject('Page_DUPSS - Phng Nga S Dng Ma Ty Trong Cng ng/input_confirmNewPassword'), 'NewPass@456')

WebUI.click(findTestObject('Page_DUPSS - Phng Nga S Dng Ma Ty Trong Cng ng/button_changePassword'))

WebUI.verifyTextPresent('Mật khẩu cũ không chính xác', false)
